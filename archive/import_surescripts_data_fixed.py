#!/usr/bin/env python3
"""
Script to import Surescripts Provider Directory data with correct field mapping.
"""
...
def import_data(file_path, batch_size=1000):
    ...
    try:
        ...
        # Field mapping based on actual data structure analysis
        field_names = [
        ...
        with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
            for line in file:
                ...
                for i, field in enumerate(fields):
                    if i in [25, 26, 29]:  # Date fields (effective_date, expiration_date, last_updated)
...
if __name__ == "__main__":
    print("Surescripts Provider Directory Data Import (Fixed)")
    print("=" * 50)
